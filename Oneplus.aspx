<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Oneplus.aspx.cs" Inherits="Oneplus" %>
            ...
            <div class="row">
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="Oneplus.aspx"><%--<asp:Image ID="Image1" ImageUrl='<%#"~/PhoneImages/"+Eval("Photo") %>' runat="server" Height="212px" Width="160" />--%>Oneplus</a></li>
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items">
                        <!--features_items-->
                        <h2 class="title text-center">Oneplus Items</h2>
                        <div class="wrapper">

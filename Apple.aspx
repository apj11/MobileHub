<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Apple.aspx.cs" Inherits="Apple" %>
            ...
            <div class="row">
                        ...
                        <div class="brands_products">
                            ...
                            <div class="brands-name">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="Oneplus.aspx"><%-- <asp:Image ID="Image1" ImageUrl='<%#"~/PhoneImages/"+Eval("Photo") %>' runat="server" Height="212px" Width="160px" ImageAlign="Middle" />--%>Oneplus</a></li>
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items">
                        <!--features_items-->
                        <h2 class="title text-center">Apple Items</h2>
                        <div class="wrapper">
                ...
                <table cellpadding="0" cellspacing="0" class="auto-style1">
                    <tr>
                        <td style="display:flex;justify-content:center;" class="nav-justified">
                           ...
                           <%-- <asp:Image ID="Image1" ImageUrl='<%#"~/PhoneImages/"+Eval("Photo") %>' runat="server" Height="212px" Width="160px" ImageAlign="Middle" />--%>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="auto-style2" style="text-align:center; background-color: #FFFFFF; color: #fe980f; font-weight: bolder; font-style: normal; padding-top: 10px; padding-bottom: 10px; ">
                            ...
                            <asp:Button ID="btnAddToCart" runat="server" Text="Cart" CommandArgument='<%# Eval("PhoneId")%>' CommandName="addtocart" OnClick="btnAddToCart_Click" />
                        </td>
                    </tr>
                </table>
                </div>
